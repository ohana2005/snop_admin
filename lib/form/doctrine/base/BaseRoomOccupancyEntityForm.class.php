...
/**
 * RoomOccupancyEntity form base class.
 * sfDoctrineFormGenerator 
 * @method RoomOccupancyEntity getObject() Returns the current form's model object
 *
 * @package    cms
 * @subpackage form
...
abstract class BaseRoomOccupancyEntityForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('room_occupancy_entity[%s]');
