<div id="sf_admin_container">
    ...
    <div>
        <div class="box-info full">
            <h2><strong><?php echo __('Prices for packages') ?></strong></h2>
            ...
            <div id="sf_admin_content">
                <div id="occupancyManager">
                    ...
                    <div id="occupancyDates">
                        <table cellpadding="0" cellspacing="0" class="occupancyTable">
                            <tr class="years">
                                <th rowspan="3"><?php echo __('Item') ?></th>
                ...
                <div class="sf_admin_actions">
                    <a class="btn btn-default" href="<?php echo url_for('price_item/index'); ?>"><?php echo __('Back to list') ?></a>
                </div>
            </div>
        </div>
