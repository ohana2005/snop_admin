<div id="sf_admin_container">
    <div class="page-heading animated fadeInDownBig">
        ...
        <h1><?php echo __('Manage prices') ?></h1>
    </div>
    ...
    <div>
        <div class="box-info full">
            <h2><strong><?php echo __('Prices for all rooms') ?></strong></h2>
                ...
                <div id="occupancyManager">
                    ...
                    <div id="occupancyDates">
                        <table cellpadding="0" cellspacing="0" class="occupancyTable">
                            ...
                            <?php foreach($RoomCategories as $RoomCat): ?>
                                <tr class="room" data-roomid="<?php echo $RoomCat->id; ?>">
                                    <th class="room-cat-name"><?php echo $RoomCat->name; ?></th>
                                    <?php foreach($period['days'] as $i => $day): ?>
                                        <?php $price = $RoomCat->getDayPrice($day['fulldate']); ?>
                                        <td class="occupancy">
                                            <div class="occupancy-holder">
                                                <div class="occupancy-hover occupancy-hover-<?php echo $i; ?>" data-num="<?php echo $i; ?>" data-fulldate="<?php echo $day['fulldate']; ?>" data-dateformatted="<?php echo date('d.m.Y', strtotime($day['fulldate'])); ?>" data-itemid="<?php echo $RoomCat->id; ?>"><?php echo $price ? $price : ''; ?></div>
                                            </div>
                                        </td>
                                    <?php endforeach; ?>
                                </tr>
                    ...
                    <div id="priceControls">
                        ...
                        <div class="buttons">
                            <button id="addPriceButton"><?php echo __('Set price') ?></button>
                        </div>
                    </div>
                </div>
